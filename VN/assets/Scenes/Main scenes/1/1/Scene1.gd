...
func _on_Button_pressed(choice):
	if choice == 'forest':
		get_tree().change_scene("res://assets/Scenes/Main scenes/1/2/Scene2.tscn")
	if choice == 'return':
		get_tree().change_scene("res://assets/Scenes/Endings/0001/Scene.tscn")
	if choice == 'city':
	...
	if choice == 'mystic':
		...
		if CharacterStats.motivation == 'suicidal':
			...
			if chance <= 40:
				get_tree().change_scene("res://assets/Scenes/Endings/0000/Scene.tscn")
