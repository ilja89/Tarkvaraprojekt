...
func _on_Button_pressed(choice):
	...
	if choice == "kill":
		get_tree().change_scene("res://assets/Scenes/Main scenes/3/30/Scene.tscn")
	if choice == "talk":
		rng.randomize()
		var chance = rng.randi_range(1, 100)
		if chance <= 25:
			get_tree().change_scene("res://assets/Scenes/Main scenes/3/31/Scene.tscn")
		elif chance <= 50:
			get_tree().change_scene("res://assets/Scenes/Main scenes/3/32/Scene.tscn")
		elif chance <= 75:
			get_tree().change_scene("res://assets/Scenes/Main scenes/3/33/Scene.tscn")
		else:
			get_tree().change_scene("res://assets/Scenes/Main scenes/3/34/Scene.tscn")
