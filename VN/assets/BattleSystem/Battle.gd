...
func _ready():
	randomize()
	#DEBUG! DELETE LATER
	sound=load("res://assets/BattleSystem/Sound/Riddles.wav")
	$music_example.set_stream(sound)
	$music_example.play(0)
	$music_example.set_volume_db(2)
	#
...
func playsound(group,id):
	...
	if(group=="sword"):
		if(id==1):
			rand=random(1,3)
			sound=load("res://assets/BattleSystem/Sound/windy/"+str(rand)+".wav")
			print("playing res://assets/BattleSystem/Sound/windy/"+str(rand)+".wav")
		...
		rand=random(1,5)
		sound=load("res://assets/BattleSystem/Sound/clang/"+str(rand)+".wav")
		print("playing res://assets/BattleSystem/Sound/clang/"+str(rand)+".wav")
		$player.set_stream(sound)
		$player.play(0)
	elif(group=="random_enemy"):
		rand=random(1,7)
		sound=load("res://assets/BattleSystem/Sound/enemy/"+str(rand)+".wav")
		print("playing res://assets/BattleSystem/Sound/enemy/"+str(rand)+".wav")
		$enemy.set_stream(sound)
		$enemy.play(0)
		emit_signal("sound_finished")
	elif(group=="player_movement"):
		rand=0
		while(rand<id):
			sound=load("res://assets/BattleSystem/Sound/steps/1.wav")
			print("playing res://assets/BattleSystem/Sound/steps/1.wav")
			$player.set_stream(sound)
			$player.play(0)
			yield($player,"finished")
			rand=rand+1
		...
		while(rand<id):
			...
			$enemy.set_stream(sound)
			$enemy.play(0)
			yield($enemy,"finished")
			rand=rand+1
		emit_signal("sound_finished")
	elif(group=="enemy_jump"):
		rand=random(1,3)
		sound=load("res://assets/BattleSystem/Sound/jump/"+str(rand)+".wav")
		print("playing res://assets/BattleSystem/Sound/jump/"+str(rand)+".wav")
		$enemy.set_stream(sound)
		$enemy.play(0)
		yield($enemy,"finished")
		emit_signal("sound_finished")
...
func _on_VideoPlayer_finished():
		$VideoPlayer.set_stream_position(0)
		$VideoPlayer.play()
